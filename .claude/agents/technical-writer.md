...
```bash
git clone https://github.com/luysantanadev/rtk-windows.git
cd rtk
cargo install --path .
...
```bash
curl -sSL https://github.com/luysantanadev/rtk-windows.git/releases/download/v0.16.0/rtk-linux-x86_64 -o rtk
chmod +x rtk
...
- **Fix**: Uninstall and reinstall correct RTK
  ```bash
  cargo uninstall rtk
  cargo install --path .  # From https://github.com/luysantanadev/rtk-windows.git repo
